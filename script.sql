...
(3, '¡Tío/a! Estoy haciendo una cometa y necesito 3 triángulos iguales. Si cada triángulo tiene 3 ángulos, ¿cuántos ángulos hay en total?', '3', '6', '9', '12', 3, NULL),
(3, 'Mi pizza circular la corté en 4 partes iguales. ¿Qué ángulo tiene cada porción en el centro?', '45°', '60°', '90°', '120°', 3, NULL),
(3, 'Tío/a, tengo un cuadrado de lado 5 cm. ¿Cuál es su perímetro?', '10 cm', '15 cm', '20 cm', '25 cm', 3, NULL),
(3, 'Mi habitación cuadrada mide 4 metros de lado. ¿Cuál es su área?', '8 m²', '12 m²', '16 m²', '20 m²', 3, NULL),
(3, '¡Ayuda! Un triángulo tiene ángulos de 60°, 60° y... ¿cuánto falta?', '30°', '60°', '90°', '120°', 2, NULL),
(3, 'Tengo 6 cubos de 1 cm de lado apilados. ¿Qué altura tiene mi torre?', '3 cm', '5 cm', '6 cm', '12 cm', 3, NULL),
(3, 'Mi rectángulo mide 10 cm de largo y 2 cm de ancho. ¿Cuál es su área?', '12 cm²', '20 cm²', '22 cm²', '24 cm²', 2, NULL),
(3, '¡Socorro! ¿Cuántos lados tiene un pentágono?', '4', '5', '6', '7', 2, NULL),
(3, 'Tío/a, un hexágono tiene 6 lados iguales de 3 cm. ¿Cuál es su perímetro?', '9 cm', '12 cm', '18 cm', '24 cm', 3, NULL),
(3, 'Mi triángulo tiene un ángulo recto (90°) y otro de 30°. ¿Cuánto mide el tercero?', '30°', '45°', '60°', '90°', 3, NULL),
(3, 'Estoy doblando un papel cuadrado por la diagonal. ¿Qué figura obtengo?', 'Un cuadrado más pequeño', 'Un rectángulo', 'Un triángulo', 'Un rombo', 3, NULL),
(3, '¡Problema! Un cubo tiene 6 caras. ¿Cuántas aristas tiene?', '6', '8', '10', '12', 4, NULL),
(3, 'Mi triángulo tiene base 6 cm y altura 4 cm. ¿Cuál es su área?', '10 cm²', '12 cm²', '20 cm²', '24 cm²', 2, NULL),
(3, 'Tío/a, ¿cuántos ángulos rectos tiene un rectángulo?', '2', '3', '4', '6', 3, NULL),
(3, 'Mi reloj marca las 3:00. ¿Qué ángulo forman las agujas?', '45°', '60°', '90°', '180°', 3, NULL),
(3, 'Tengo un cuadrado de lado 10 cm. ¿Cuál es su área?', '20 cm²', '40 cm²', '80 cm²', '100 cm²', 4, NULL),
(3, '¡Ayuda rápido! ¿Cuántos vértices tiene un triángulo?', '2', '3', '4', '5', 2, NULL),
(3, 'Mi rectángulo mide 8 cm de largo y 3 cm de ancho. ¿Cuál es su perímetro?', '11 cm', '16 cm', '22 cm', '24 cm', 3, NULL),
(3, 'Tío/a, corté mi pastel circular en 6 partes iguales. ¿Qué ángulo tiene cada trozo?', '30°', '45°', '60°', '90°', 3, NULL),
(3, 'Un ángulo mide 45°. ¿Cuánto le falta para llegar a 90°?', '30°', '45°', '50°', '90°', 2, NULL),
(3, '¡Socorro! Mi cuadrado tiene perímetro 20 cm. ¿Cuánto mide cada lado?', '4 cm', '5 cm', '10 cm', '20 cm', 2, NULL),
(3, 'Tengo un círculo. ¿Cuántos lados tiene?', '0', '1', '4', 'Infinitos', 1, NULL),
(3, 'Mi triángulo tiene todos los lados iguales. ¿Cuánto mide cada ángulo?', '45°', '60°', '90°', '120°', 2, NULL),
(3, 'Tío/a, un cubo tiene 8 vértices. ¿Cuántas caras tiene?', '4', '6', '8', '12', 2, NULL),
(3, 'Mi rectángulo mide 5 cm × 4 cm. ¿Cuál es su área?', '9 cm²', '18 cm²', '20 cm²', '25 cm²', 3, NULL),
(3, '¡Problema urgente! ¿Cuántas diagonales tiene un cuadrado?', '0', '2', '4', '8', 2, NULL),
(3, 'Tengo un ángulo de 100°. ¿Es agudo, recto u obtuso?', 'Agudo', 'Recto', 'Obtuso', 'Llano', 3, NULL),
(3, 'Mi cuadrado de lado 6 cm, ¿qué perímetro tiene?', '12 cm', '18 cm', '24 cm', '36 cm', 3, NULL),
(3, 'Tío/a, si un triángulo tiene un ángulo de 90°, ¿cómo se llama?', 'Equilátero', 'Isósceles', 'Rectángulo', 'Escaleno', 3, NULL),
(3, '¿Cuántos lados tiene un octágono?', '6', '7', '8', '10', 3, NULL),
(3, 'Mi triángulo tiene base 8 cm y altura 5 cm. ¿Cuál es su área?', '13 cm²', '20 cm²', '40 cm²', '80 cm²', 2, NULL),
(3, '¡Ayuda! Dos ángulos suman 90°. Si uno mide 40°, ¿cuánto mide el otro?', '40°', '50°', '60°', '90°', 2, NULL),
(3, 'Un rectángulo tiene largo 12 cm y ancho 5 cm. ¿Cuál es su perímetro?', '17 cm', '24 cm', '34 cm', '60 cm', 3, NULL),
(3, 'Tío/a, ¿cuántos ejes de simetría tiene un cuadrado?', '2', '4', '6', '8', 2, NULL),
(3, 'Mi pirámide tiene base cuadrada. ¿Cuántas caras tiene en total?', '4', '5', '6', '8', 2, NULL),
(3, 'Un ángulo mide 180°. ¿Cómo se llama?', 'Agudo', 'Recto', 'Obtuso', 'Llano', 4, NULL),
(3, '¡Socorro! Mi cuadrado tiene área 25 cm². ¿Cuánto mide su lado?', '5 cm', '6 cm', '12.5 cm', '25 cm', 1, NULL),
(3, '¿Cuántos vértices tiene un hexágono?', '5', '6', '7', '8', 2, NULL),
(3, 'Mi triángulo tiene ángulos de 50° y 50°. ¿Cuánto mide el tercero?', '50°', '60°', '80°', '100°', 3, NULL),
(3, 'Tío/a, un rombo tiene 4 lados iguales de 7 cm. ¿Cuál es su perímetro?', '14 cm', '21 cm', '28 cm', '35 cm', 3, NULL),
(3, '¿Cuántos ángulos tiene un pentágono?', '4', '5', '6', '7', 2, NULL),
(3, 'Mi rectángulo mide 6 cm × 6 cm. ¿Qué figura es en realidad?', 'Un rectángulo diferente', 'Un cuadrado', 'Un rombo', 'Un trapecio', 2, NULL),
(3, '¡Problema! La suma de ángulos de un triángulo es...?', '90°', '180°', '270°', '360°', 2, NULL),
(3, 'Mi cubo tiene arista de 2 cm. ¿Cuál es su volumen?', '4 cm³', '6 cm³', '8 cm³', '12 cm³', 3, NULL),
(3, 'Tío/a, ¿cuántos lados tiene un cuadrilátero?', '3', '4', '5', '6', 2, NULL),
(3, 'Mi triángulo rectángulo tiene catetos de 3 cm y 4 cm. ¿Cuál es su área?', '6 cm²', '7 cm²', '12 cm²', '24 cm²', 1, NULL),
(3, 'Un ángulo de 70° más otro de 20° suman...?', '50°', '80°', '90°', '100°', 3, NULL),
(3, '¡Ayuda! Mi cuadrado tiene perímetro 40 cm. ¿Cuánto mide su lado?', '8 cm', '10 cm', '20 cm', '40 cm', 2, NULL),
(3, '¿Cuántas caras tiene un cilindro?', '1', '2', '3', '4', 3, NULL),
(3, 'Tío/a, mi rectángulo mide 10 cm × 3 cm. ¿Cuál es su área?', '13 cm²', '26 cm²', '30 cm²', '60 cm²', 3, NULL);
GO
