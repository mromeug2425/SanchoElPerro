...
INSERT INTO preguntas (id_juego, pregunta, opcion_1, opcion_2, opcion_3, opcion_4, answer, media) VALUES
(1, '¿Cuánto es 7 × 8?', '54', '56', '64', '58', 'B', NULL),
(1, '¿Cuánto es 45 ÷ 5?', '8', '9', '10', '12', 'B', NULL),
(1, '¿Cuál es la raíz cuadrada de 81?', '8', '9', '10', '11', 'B', NULL),
(1, 'Si 5x = 20, ¿cuánto vale x?', '2', '3', '4', '5', 'C', NULL),
(1, '¿Cuánto es 25% de 200?', '25', '40', '50', '75', 'B', NULL),
(1, '¿Qué número es mayor?', '0,75', '3/4', 'Son iguales', '1/2', 'C', NULL),
(1, 'Si un triángulo tiene lados 3, 4 y 5, ¿qué tipo de triángulo es?', 'Isósceles', 'Escaleno', 'Rectángulo', 'Equilátero', 'C', NULL),
(1, '¿Cuánto es (6 + 4) × 2?', '20', '16', '12', '10', 'A', NULL),
(1, '¿Cuál es el resultado de 3² + 4²?', '12', '24', '25', '49', 'C', NULL),
(1, '¿Cuánto es 0,5 + 0,25?', '0,7', '0,75', '0,8', '1', 'B', NULL),
(1, '¿Cuál es el valor aproximado de π?', '2,12', '3,14', '3,5', '3,41', 'B', NULL),
(1, 'Si un coche recorre 120 km en 2 horas, ¿a qué velocidad media va?', '50 km/h', '60 km/h', '80 km/h', '40 km/h', 'B', NULL),
(1, '¿Qué número es divisible entre 3?', '124', '135', '142', '152', 'B', NULL),
(1, '¿Cuánto es 1000 − 475?', '425', '525', '475', '375', 'A', NULL),
(1, '¿Cuánto es 2³?', '6', '8', '9', '12', 'B', NULL),
(1, '¿Cuánto es ⅓ de 90?', '20', '25', '30', '40', 'C', NULL),
(1, 'Si un cuadrado tiene lados de 5 cm, ¿cuál es su perímetro?', '10 cm', '20 cm', '25 cm', '30 cm', 'B', NULL),
(1, '¿Cuál es el número primo?', '9', '12', '13', '15', 'C', NULL),
(1, 'Si una pizza se divide en 8 partes y comes 3, ¿qué fracción has comido?', '1/3', '3/8', '1/4', '2/3', 'B', NULL),
(1, '¿Cuánto es 4 × (2 + 3)?', '10', '12', '20', '24', 'C', NULL),
(1, '¿Cuál es el valor de x si 12 + x = 20?', '6', '8', '10', '12', 'B', NULL),
(1, '¿Qué figura tiene 4 lados iguales y 4 ángulos rectos?', 'Rectángulo', 'Cuadrado', 'Rombo', 'Trapecio', 'B', NULL),
(1, '¿Cuál es la mitad de 3/4?', '1/2', '3/8', '1/4', '2/3', 'A', NULL),
(1, 'Si hoy es martes, ¿qué día será dentro de 5 días?', 'Viernes', 'Domingo', 'Lunes', 'Sábado', 'B', NULL),
(1, '¿Cuánto es 11 × 12?', '121', '132', '142', '112', 'B', NULL),
(1, '¿Cuánto es 9 + 6 ÷ 3?', '3', '13', '11', '15', 'C', NULL),
(1, '¿Cuál es el doble de 7,5?', '12,5', '13', '15', '20', 'C', NULL),
(1, '¿Qué número sigue en la serie: 2, 4, 8, 16, ...?', '18', '20', '24', '32', 'D', NULL),
(1, '¿Cuánto es 15% de 200?', '15', '25', '30', '35', 'C', NULL),
(1, '¿Cuánto es 5²?', '20', '10', '25', '30', 'C', NULL),
(1, '¿Cuál es el opuesto de -12?', '12', '-12', '0', '-1', 'A', NULL),
(1, '¿Qué fracción equivale a 0,5?', '1/3', '1/2', '3/4', '2/3', 'B', NULL),
(1, '¿Cuál es el área de un rectángulo de 5 × 8?', '10', '13', '40', '48', 'C', NULL),
(1, '¿Cuántos segundos hay en 5 minutos?', '300', '200', '250', '150', 'A', NULL),
(1, '¿Cuánto es 10% de 450?', '40', '45', '50', '55', 'B', NULL),
(1, '¿Cuál es el triple de 9?', '18', '27', '36', '30', 'B', NULL),
(1, '¿Cuánto es 14 + 28 + 14?', '42', '50', '56', '60', 'C', NULL),
(1, '¿Cuánto es 90 ÷ 9?', '8', '9', '10', '12', 'B', NULL),
(1, '¿Cuál es la raíz cuadrada de 100?', '9', '10', '11', '12', 'B', NULL),
(1, '¿Qué número falta: 5, 10, 15, ?, 25?', '18', '20', '22', '23', 'B', NULL),
(1, '¿Cuánto es 2 × 2 × 2 × 2?', '6', '8', '10', '16', 'D', NULL),
(1, '¿Cuánto es 3 × (7 + 5)?', '24', '30', '36', '40', 'C', NULL),
(1, '¿Cuál es la mitad de 1 hora?', '15 minutos', '30 minutos', '45 minutos', '60 minutos', 'B', NULL),
(1, '¿Cuánto es 4² + 5²?', '20', '25', '41', '45', 'C', NULL),
(1, '¿Cuál es el sucesor de 999?', '1000', '998', '1100', '900', 'A', NULL),
(1, '¿Qué número es múltiplo de 4?', '18', '20', '22', '26', 'B', NULL),
(1, '¿Cuál es la fracción equivalente a 2/4?', '1/2', '3/4', '2/3', '1/3', 'A', NULL),
(1, '¿Cuánto es 120 ÷ 10?', '10', '12', '15', '20', 'B', NULL),
(1, '¿Cuánto es 6 × 9?', '54', '56', '58', '60', 'A', NULL),
(1, '¿Qué número es mayor: 0,6 o 0,59?', '0,6', '0,59', 'Son iguales', 'No se puede saber', 'A', NULL),
(1, '¿Cuánto es 1/5 de 100?', '10', '15', '20', '25', 'C', NULL),
(1, '¿Cuánto es 9²?', '81', '72', '90', '99', 'A', NULL),
(1, '¿Cuánto es 3 × 12?', '33', '34', '35', '36', 'D', NULL),
(1, '¿Cuánto es 200 − 175?', '10', '20', '25', '30', 'C', NULL),
(1, '¿Cuánto es 8 × 11?', '81', '88', '80', '99', 'B', NULL),
(1, '¿Cuál es el número par?', '7', '13', '16', '21', 'C', NULL),
(1, '¿Cuánto es 100 ÷ 25?', '2', '3', '4', '5', 'C', NULL),
(1, '¿Cuánto es la raíz cuadrada de 49?', '6', '7', '8', '9', 'B', NULL),
(1, '¿Qué número es impar?', '8', '10', '15', '20', 'C', NULL),
(1, '¿Cuánto es 5 + 5 × 5?', '25', '30', '50', '15', 'B', NULL),
(1, '¿Cuánto es 12 × 12?', '124', '132', '144', '154', 'C', NULL),
(1, '¿Cuál es el doble de 13?', '25', '26', '27', '28', 'B', NULL),
(1, '¿Cuánto es 8³?', '512', '64', '128', '216', 'A', NULL),
(1, '¿Cuánto es 2⁵?', '16', '32', '64', '128', 'B', NULL),
(1, '¿Cuánto es ¼ de 60?', '10', '12', '15', '20', 'C', NULL),
(1, '¿Qué número sigue en la secuencia 1, 4, 9, 16, ...?', '20', '24', '25', '36', 'C', NULL),
(1, '¿Cuál es el resultado de 2 × (3 + 7)?', '20', '12', '14', '24', 'A', NULL),
(1, '¿Cuánto es 18 ÷ 6 + 4?', '6', '7', '8', '9', 'C', NULL),
(1, '¿Cuánto es 9 × 5?', '35', '40', '45', '50', 'C', NULL),
(1, '¿Cuánto es 100 − 99?', '0', '1', '2', '10', 'B', NULL),
(1, '¿Cuál es el número más pequeño?', '0,1', '0,01', '0,001', '0,0001', 'D', NULL),
(1, '¿Cuánto es ¾ de 100?', '50', '60', '70', '75', 'D', NULL),
(1, '¿Cuánto es 8 + 12?', '18', '19', '20', '21', 'C', NULL),
(1, '¿Cuánto es 1/2 + 1/4?', '1/3', '1/2', '3/4', '1', 'C', NULL),
(1, '¿Cuánto es 6²?', '36', '30', '42', '48', 'A', NULL),
(1, '¿Cuál es la raíz cuadrada de 64?', '6', '7', '8', '9', 'C', NULL),
(1, '¿Cuánto es 7 × 7?', '47', '48', '49', '50', 'C', NULL),
(1, '¿Qué número es múltiplo de 5?', '22', '25', '27', '28', 'B', NULL),
(1, '¿Cuánto es 1 hora y media en minutos?', '60', '90', '100', '120', 'B', NULL),
(1, '¿Cuánto es 3 × 3 × 3?', '9', '18', '27', '36', 'C', NULL),
(1, '¿Cuánto es 0,2 × 100?', '2', '10', '20', '200', 'C', NULL),
(1, '¿Qué número falta: 10, 20, 30, ?, 50?', '35', '38', '40', '45', 'C', NULL),
(1, '¿Cuánto es ½ de 200?', '50', '75', '100', '125', 'C', NULL),
(1, '¿Cuánto es 7 + 3 × 2?', '14', '16', '18', '20', 'A', NULL),
(1, '¿Cuál es la raíz cuadrada de 121?', '10', '11', '12', '13', 'B', NULL),
(1, '¿Cuánto es 5 × 0?', '0', '5', '1', '10', 'A', NULL),
(1, '¿Qué número es divisible entre 9?', '18', '19', '20', '21', 'A', NULL),
(1, '¿Cuánto es 6 + 9 − 4?', '10', '11', '12', '13', 'C', NULL),
(1, '¿Cuánto es 4³?', '12', '16', '64', '128', 'C', NULL),
(1, '¿Cuánto es el triple de 15?', '30', '40', '45', '50', 'C', NULL),
(1, '¿Cuál es el resultado de 2 + 2 × 2?', '6', '8', '4', '2', 'A', NULL),
(1, '¿Cuánto es 5⁴?', '125', '625', '3125', '25', 'B', NULL),
(1, '¿Qué número es mayor: 0,99 o 1?', '0,99', '1', 'Son iguales', 'Ninguno', 'B', NULL),
(1, '¿Cuánto es ⅔ de 90?', '45', '50', '55', '60', 'D', NULL),
(1, '¿Cuánto es 200 × 0?', '0', '2', '20', '200', 'A', NULL),
(1, '¿Cuánto es 8 + 8 ÷ 4?', '10', '12', '14', '16', 'B', NULL),
(1, '¿Cuál es la raíz cuadrada de 144?', '10', '11', '12', '13', 'C', NULL),
(1, '¿Cuánto es 9 + 10?', '18', '19', '20', '21', 'B', NULL),
(1, '¿Cuánto es 2 × 25?', '45', '50', '55', '60', 'B', NULL),
(1, '¿Cuánto es 15 + 15?', '25', '30', '35', '40', 'B', NULL),
(1, '¿Qué número es múltiplo de 9?', '18', '20', '22', '24', 'A', NULL),
(1, '¿Cuánto es 8 × 8?', '56', '60', '64', '72', 'C', NULL),
(1, '¿Cuánto es 5 + 15 + 20?', '35', '40', '45', '50', 'B', NULL),
(1, '¿Cuánto es 0,1 × 1000?', '10', '100', '1', '0,01', 'A', NULL),
(1, '¿Cuánto es 10²?', '50', '100', '150', '200', 'B', NULL),
